...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/10/26 12:15:41 by abodnar           #+#    #+#              #
#    Updated: 2018/01/06 14:08:17 by abodnar          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	...
	ft_sqrt.c ft_swap.c ft_strswap.c ft_strgsort.c ft_strrev.c ft_itoa_base.c

OFLS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	...
	ft_sqrt.o ft_swap.o ft_strswap.o ft_strgsort.o ft_strrev.o ft_itoa_base.o
